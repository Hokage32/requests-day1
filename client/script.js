...
const repeatMyParam = () => {
    axios.get('http://localhost:3000/repeat/HELP ME').then((res) => {
...
// CODE HERE
function getReq(){
    axios.get('http://localhost:3000/query-test/?name=levi').then((res) => {
        console.log(res.data)
    })
}
document.getElementById('query-button').addEventListener('click', getReq)
